...
public class MainViewController implements Initializable {
    ...
    private final int num = 36; //number Of Characters In Default Directory Name
    ...
    public void startAlgorithm(ActionEvent event) throws IOException {
        try{
            ...
            String temp = "/home/wz960506/Dokumenty/various/tmp";
    ...
    private void setDefaultTextFields() {
        ...
        pathTextField.setText("/home/wz960506/Dokumenty/various/tmp");
	...
	/*
	It is acceptable to pass 3-digit positive or negative number.
	Spaces can be before or after the number.
	If we pass more than one number, than there should be a comma between them.
	*/        
